...
class AtemioBackupManager(Screen):
	skin = """
  ...
  <ePixmap alphatest="blend" pixmap="skin_default/buttons/key_menu.png" position="1146,52" size="81,40" />
  <ePixmap alphatest="blend" pixmap="skin_default/buttons/key_epg.png" position="1035,52" size="81,40" />
  <widget font="Regular;22" halign="left" name="lab1" position="470,135" size="750,70" transparent="1" valign="top" zPosition="2" />
  <widget name="list" position="470,220" scrollbarMode="showOnDemand" size="750,410" transparent="1" zPosition="2" />
  ...
  <applet type="onLayoutFinish">
	...
	def createSetup(self):
		self.session.openWithCallback(self.setupDone, AtemioBackupManagerMenu, 'atemiobackupmanager', 'SystemPlugins/AtemioCore')

	def showLog(self):
		self.sel = self['list'].getCurrent()
		if self.sel:
			filename = self.BackupDirectory + self.sel
			self.session.open(AtemioBackupManagerLogView, filename)
...
class AtemioBackupManagerMenu(Setup):
	skin = """
	  <screen position="0,0" size="1280,720">
	  <eLabel  name="new eLabel" position="462,119" size="720,2" />
	  <ePixmap alphatest="blend" pixmap="skin_default/buttons/green.png" position="610,637" size="30,35" />
	  <ePixmap alphatest="blend" pixmap="skin_default/buttons/yellow.png" position="805,637" size="30,35" />
	  <ePixmap alphatest="blend" pixmap="skin_default/buttons/red.png" position="415,636" size="30,35" />
	  <widget font="Regular; 22" halign="left" name="key_red" position="450,640" size="160,24" transparent="1" zPosition="1" />
	  <widget font="Regular; 22" halign="left" name="key_green" position="645,640" size="160,24" transparent="1" zPosition="1" />
	  <widget font="Regular;22" halign="left" name="key_yellow" position="840,640" size="160,24" transparent="1" zPosition="1" />
	  <widget enableWrapAround="1" font="Regular;22" foregroundColor="foreground" itemHeight="30" name="config" position="470,135" scrollbarMode="showOnDemand" size="750,560" transparent="1" valign="top" />
	  <widget name="footnote" position="590,500" size="600,20" zPosition="1" font="Regular;20" halign="left" transparent="1" valign="top" />
	  <widget name="description" position="590,530" size="600,77" font="Regular;18" halign="center" valign="top" transparent="0" zPosition="1" />
	</screen>"""
...
class AtemioBackupManagerLogView(Screen):
	skin = """
	  <screen position="0,0" size="1280,720" >
	  <eLabel backgroundColor="metrixAccent1" name="new eLabel" position="462,119" size="720,2" />
	  <widget name="waitingtext" position="0,0" size="0,0" />
	  <widget font="Regular;22" foregroundColor="grey" itemHeight="28" name="list" position="470,135" size="755,532" transparent="1" />
	</screen>"""
	...
	def __init__(self, session, filename):
		...
		self.skinName = "AtemioBackupManagerLogView"
