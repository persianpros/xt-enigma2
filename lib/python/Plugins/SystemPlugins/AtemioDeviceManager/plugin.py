...
def deviceManagerSetup(menuid, **kwargs):
	if menuid != "system":
		return []
	return [(_("Atemio Device Manager"), deviceManagerMain, "deviceManager", 5)]
...
def Plugins(**kwargs):
	return [PluginDescriptor(name = _("Atemio Device Manager"), description = _("Format/Partition your Devices and manage Mountpoints"), where = PluginDescriptor.WHERE_MENU, fnc = deviceManagerSetup),
